...
def chat(message, history):
    ...
    # Testing retrieve method  - Milestone 2 
    # print(f"Query: {query}")
    # print(f"Top result game: {top_result['game']}")
    # print(f"Distance score: {top_result['distance']}")
    # print(f"Chunk text: {top_result['text']}")

    # # Evaluate if the result makes sense
    # assert top_result["game"] == "Catan", "Top result is not from Catan"
    # print("Does it make sense? Yes")
