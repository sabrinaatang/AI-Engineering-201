...
Documents were processed via load_documents() and chunk_document()
- load_documents(): looped through all documents in doc folder and read them
- chunk_document(): breaks text in to chunks before processing, purpose of the overlap is to make sure the consecutive chunks share a portion of their content, useful for maintaining context between chunks
...
.
[
    {"text": "ABCDE", "game": "Example", "chunk_id": "example_0"},
    {"text": "DEFGH", "game": "Example", "chunk_id": "example_1"},
    {"text": "GHIJK", "game": "Example", "chunk_id": "example_2"},
    {"text": "JKLMN", "game": "Example", "chunk_id": "example_3"},
    {"text": "MNO", "game": "Example", "chunk_id": "example_4"},
] --> example of the returned chunks list


**Actual chunk count produced across all 8 rule books:**

```
Stored 149 total chunks in the vector database (when chunk size was 300).
```
